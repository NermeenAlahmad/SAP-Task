sap.ui.define([
...
], function(Log, Controller, JSONModel, _MessageBox, _MessageToast, DateFormat, jQuery) {
	"use strict";
	...
	return Controller.extend("sap.ui.table.sample.Basic.Controller", {
		...
		handleDetailsPress: function(oEvent) {
			sap.m.MessageBox.alert("Assig Count Reference");
		},

		onPaste: function(oEvent) {
			var aData = oEvent.getParameter("data");
			sap.m.MessageBox.alert("Pasted Data: " + aData);
		}
